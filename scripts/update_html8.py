    ...
    <div id="decrypt-prompt" class="hidden absolute z-50 cyber-card rounded-xl shadow-[0_0_20px_rgba(6,182,212,0.5)] border-cyan-400 w-full max-w-sm flex flex-col bg-[#020617] bg-opacity-95 backdrop-blur-md" style="top: 25%; left: 50%; transform: translate(-50%, -50%);">
        ...
        <div class="p-4 flex flex-col pt-2">
            ...
            <div class="flex gap-2">
                ...
                <button id="hint-btn" onclick="takeHint()" class="hidden py-2.5 px-4 bg-yellow-900 bg-opacity-70 hover:bg-yellow-700 text-yellow-400 hover:text-white orbitron font-bold border border-yellow-500 transition-all text-xs rounded tracking-widest shadow-md" title="Get Hint (-60 Points)">HINT (-60)</button>
            </div>
